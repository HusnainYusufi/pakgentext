                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="table1" class="display" style="min-width: 845px">
										...
										<tr> 
											...
											<td><button class="btn btn-success" id="wd">Open</button></td>											   
										</tr>
										<tr> 
											<td>2</td>
											<td>Spoken Discourse Discourse</td>
											<td><button class="btn btn-success" id="sd">Open</button></td>											   
										</tr>
                                    </tbody>
                                    </table>
...
<script type="text/javascript">
				...
				$("body").on("click" , "#wd" , function(){
                    sessionStorage.setItem("path", "PakGenText Written");
					window.location.href =  './writtendiscourse.php';
				})

				$("body").on("click" , "#sd" , function(){
					window.location.href =  './spokendiscourse.php';
				})
