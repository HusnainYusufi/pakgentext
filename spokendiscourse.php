                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Spoken Discourse</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="table1" class="display" style="min-width: 845px">
										...
										<tr> 
											...
											<td><button class="btn btn-success" id="sad">Open</button></td>											   
										</tr>
                                        <tr> 
											<td>2</td>
											<td>Media Discourse</td>
											<td><button class="btn btn-success" id="smd">Open</button></td>											   
										</tr>
...
<script type="text/javascript">
        ...
        order: false,
                ...
                $("body").on("click" , "#sad" , function(){
					window.location.href =  './spokenacademicdiscourse.php';
				})

                $("body").on("click" , "#smd" , function(){
					window.location.href =  './spokenmediadiscourse.php';
				})
